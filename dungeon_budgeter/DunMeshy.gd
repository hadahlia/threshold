...
func set_start(val:bool)->void:
	if Engine.is_editor_hint():
		create_dungeon()
var dun_cell_scene : PackedScene = preload("res://dungeon_budgeter/DunCell.tscn")
#@onready var player_scene : CharacterBody3D = $"../Yua_Player"
...
func create_dungeon():
	...
	for cell in grid_map.get_used_cells():
		...
		&& cell_index >=0:
			...
			dun_cell.position = Vector3(cell) + Vector3(0.5,-0.2,0.5)
			add_child(dun_cell)
